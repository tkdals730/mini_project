...
class PatrolLaunchSupervisor:
    ...
    def start(self):
        ...
        arg_names = [
            ...
            "use_fire_response",
            "camera_view_topic",
            "fire_stop_window_sec",
            "fire_stop_required_sec",
            "fire_alert_window_sec",
            "fire_alert_required_sec",
            "fire_clear_window_sec",
            "fire_clear_max_sec",
            "mapping_strategy",
            "rviz_config",
            "world_name",
            ...
            "frontier_max_exploration_time_sec",
            ...
            "frontier_blocked_sector_enabled",
            "frontier_blocked_sector_width",
            "frontier_blocked_sector_depth",
            "frontier_blocked_sector_backtrack",
            "completion_escape_enabled",
            "completion_escape_reverse_sec",
            "completion_escape_reverse_speed",
            "clear_costmaps_before_home",
            "spawn_x",
            "spawn_y",
            "spawn_z",
            "spawn_yaw",
